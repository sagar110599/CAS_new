                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea name="" class="form-control" id="hodremarkscum" name="hodremarkscum" maxlength="200" cols="30" rows="10"></textarea>
                                        </div>
                                    </div>
                                </div>
								<?php
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input"  name="casrecommend" id="casrecommended" value="1"> Approve for CAS</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="casrecommend" id="casnotrecommended" value="1" > Disapprove for CAS
                                                </label>
                                            </div>
                                        </div>
                                    </div>
