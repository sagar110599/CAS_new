				...
				for(var i=0;i<result.length;i++)
				{
					...
					$.each(res, function(k, v) {
					    ...
					    else
					    {
					    	...
					    	{
					    		room++;
							    var objTo = document.getElementById('col-mod-12')
							    var divtest = document.createElement("div");
								divtest.setAttribute("class", "control-group input-group style=margin-top:10px");
								//var rdiv = 'removeclass'+room;
							    
							    if(room!=1)
							    {
							    	divtest.innerHTML = '<div class="control-group input-group" style="margin-top:10px">'+
                                                '<input type="text" id="srno1"'+room+' name="srno[]" value="" data-toggle="tooltip" title="SrNo." placeholder="Sr.no" class="form-control">'+
                                                '<input type="text" id="course1"'+room+' name="course[]" value="" data-toggle="tooltip" title="Name of summer School/Course" maxlength="100" placeholder="Name of summer School/Course" class="form-control">'
                                                +'<input type="text" id="days1"'+room+' name="days[]" value="" data-toggle="tooltip" title="Duration(Days)" placeholder="Duration(Days)" class="form-control">'
                                                +'<input type="text" id="agency1"'+room+' name="agency[]" value="" data-toggle="tooltip" title="Organising Agency" placeholder="Organising Agency"class="form-control">'
                                                +'<input type="text" id="rolee1"'+room+' name="rolee[]" value="" data-toggle="tooltip" title="If organised in KJSCE, mention the role played" placeholder="If organised in KJSCE, mention the role played" class="form-control">'
